      ...
      <div className="container">
        <div className="flex flex-col items-center ">
          <Image
            ...
            className="size-[150px] rounded-full border-[4px] border-t-purple-100 shadow-[0_10px_30px_rgba(20,20,20,20.9)] md:size-[180px]"
          />
        ...
        <div className="flex items-center justify-center flex-col md:flex-row mt-8 gap-4 relative z-10">
          ...
          <Link href="/aliyahya.pdf" download="aliyahya.pdf">
